        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full rounded-pill bg-surface-card-hover px-5 py-3 font-mono text-base tracking-wide text-text-primary outline-none ring-1 ring-border transition placeholder:font-sans placeholder:text-text-muted focus:ring-2 focus:ring-brand-navy"
            />
            <p
              id="identity-hint"
